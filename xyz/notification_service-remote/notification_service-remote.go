...
func Usage() {
	...
	fmt.Fprintln(os.Stderr, "  string send(string url, Transaction transaction)")
	fmt.Fprintln(os.Stderr)
	os.Exit(0)
}
...
func main() {
	...
	client := xyz.NewNotificationServiceClientFactory(trans, protocolFactory)
